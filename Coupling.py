...
from Solvers.CouplingSolver import hpCoupling, lpCoupling
...
# Choose between Low Pressure Side as 'LP' or High Pressure Side as 'HP'. No nozzle mass flow restriction.
...
if coupling == "HP":
    ...
    print("Non-valid coupling selection -> Choose 'HP' or 'LP'")
    exit()
