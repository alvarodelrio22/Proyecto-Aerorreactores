...
def lpCoupling(beta_LPC,N_LPC,max_iterations,representing):
...
# An iterative process is requiered (using beta achieves better ortogonality than N):
    ...
    while np.isnan(error) or error >= 1e-3:
        ...
        if np.isnan(N_HPC):
            ...
            m_25, p3t_p25t, eta_HPC, m_41, p45t_p41t, eta_HPT, m_45, T45t_T25t, p45t_p25t, fuel_param = hpCoupling(beta_HPC, N_HPC, 100, 0.85, False)
