...
from Components.DesignVariables import p_ref, T_ref, gamma_c, gamma_e, Cp_c, Cp_e, f_assumed, b_3, R, A8, eta_d, N_ref_c
...
def engOperation(M0, N_c, nozzle, num_iter0, relaxation_factor):
    ...
    def engLoop(beta_c, iterate):
        ...
        coupling(beta_c, N_c, num_iter0,rel_factor, False)

        m_0 = m_2/np.sqrt(T2t_T0)*p2t_p0
        fuel_param = T3t_T2t*T2t_T0*fuel_param_uncorrected*m_0        
